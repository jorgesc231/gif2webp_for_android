...
// NOTE: Para que funcione unicode_gif, deberia haber una mejor forma
...
int gif2webp_execute(int argc, char* argv[]) {
  int verbose = 0;
...
Java_com_example_basura_gif2webp_MainActivity_nativegif2webpExecute(
        JNIEnv* env,
        jobject /* this */,
    ...
    argv[0] = (char *)malloc(sizeof(char) * (strlen("gif2webp") + 1));
    strcpy(argv[0], "gif2webp");
    ...
    // RUN
    // TODO: Deberia comprobar errores y reportarlos.
    int retCode = gif2webp_execute(argumentCount, argv);
